...
export default ts.config(
	...
	{
		// The example runs in Node and prints to a terminal. Declared here rather
		// than pulled from a globals package: two names are not worth a dependency
		// in a library that ships three.
		files: ['example/**/*.mjs', 'bin/**/*.mjs'],
		languageOptions: {
